...
(models/chemeleon_thermo_122e91.ckpt). One checkpoint, 9 log10-space
...
- rmgpu/ml/thermo_estimator.py:
    ...
    (models/chemeleon_thermo_122e91.ckpt) via base.load_chemprop_model.
...
- tests/test_thermo_ml.py: synthetic-model plumbing (predict on 10 molecules
  ...
  ThermoML on models/chemeleon_thermo_122e91.ckpt reproduces the reference
...
## Checks (must run and pass before you claim done)
  ...
  ThermoML loads models/chemeleon_thermo_122e91.ckpt and reproduces the
