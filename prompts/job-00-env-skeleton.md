...
in one session - it is decomposed into the steps below, one human-started
session each. The human reads STATUS.md's NEXT pointer; this file is the
map of the job.
