...
(`models/chemeleon_thermo_662946.ckpt`, 9 log10-space targets: log_H298_J_mol,
log_S298_J_mol_K, log_Cp_1..7_J_mol_K at 300/400/500/600/800/1000/1500 K) and the
Chemprop RIGR reaction checkpoint (`models/chemprop_kinetics_662946.ckpt`, targets
...
## Steps (strictly sequential; one fresh human-started session each)
  ...
  step 01  prompts/steps/job-04-step-01-ml-infra.md  ML infra: vendored-checkpoint verification + load path
