...
referencing==0.37.0
rich==15.0.0
-e git+ssh://git@github.com/JacksonBurns/rmgpu.git@1eb227c05ff70c2296662117b0f0d385caf90590#egg=rmgpu
rpds-py==2026.6.3
ruamel.yaml==0.19.1
scikit-learn==1.9.0
scipy==1.17.1
...
### Current: two checkpoints vendored in this repo's models/
